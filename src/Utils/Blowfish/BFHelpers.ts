// From: https://github.com/egoroof/blowfish/blob/master/src/helpers.mjs

import { MODE, PADDING } from './BFConstants.js';
...
export function isStringOrBuffer(val: any) {
  return isString(val) || isBuffer(val);
}

export function includes(obj: any, val: any) {
  let result = false;
